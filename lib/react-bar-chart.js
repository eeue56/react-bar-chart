	...
	var BarChart = (function (_React$Component) {
	  ...
	  _createClass(BarChart, [{
	    ...
	    value: function _reusableGraph(props) {
	      ...
	      svg.append('g').attr('class', 'x axis').attr('transform', 'translate(0, ' + height + ')').call(this.xAxis).append('text').attr('transform', 'rotate(-90)').attr('y', 6).attr('dy', '-.71em').style('text-anchor', 'end').text(props.xlabel);
	      ...
	      }).attr('width', props.barWidth || this.x.rangeBand()).attr('y', function (d) {
	    ...
	    key: '_setWidth',
	    value: function _setWidth(props) {
