	...
	var BarChart = (function (_React$Component) {
	  ...
	  _createClass(BarChart, [{
	    ...
	    value: function _reusableGraph(props) {
	      ...
	      svg.append('g').attr('class', 'x axis').attr('transform', 'translate(0, ' + height + ')').call(this.xAxis).append('text').attr('x', props.width / 2).attr('dy', '2.3em').style('text-anchor', 'end').text(props.xlabel);
